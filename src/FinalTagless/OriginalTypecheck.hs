{-# LANGUAGE GADTs, ScopedTypeVariables, MultiParamTypeClasses, FunctionalDependencies, FlexibleInstances,
...
module FinalTagless.OriginalTypecheck where

import FinalTagless.Original
